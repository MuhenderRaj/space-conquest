...
public class Description extends JPanel{
    ...
    public Description(){
        ...
        setFocusable(true);
        requestFocus();
        setSize(GamePanel.description.getSize());
        init();
    }  
    ...
    protected void paintComponent(Graphics g){
        ...
        Rectangle2D fontRect = g.getFontMetrics().getStringBounds("Description", g2D);
        
        g2D.setColor(Color.WHITE);
        g2D.drawString("Description", this.getWidth() / 2 - (int)(fontRect.getWidth() / 2), 200 + (int)(fontRect.getHeight() / 2));
