 ...
 */
public class GenericScreenForCopyConvenience extends JPanel{
    public JButton play, mainMenu, quit;
    private final int buttonWidth, buttonHeight;
    private ActionListener ac;
    
    public GenericScreenForCopyConvenience(){
        super();
        buttonWidth = 200;
        buttonHeight = 60;
    ...
    protected void paintComponent(Graphics g){
        ...
        Rectangle2D fontRect = g.getFontMetrics().getStringBounds("Lorem Ipsum", g2D);
        
        g2D.setColor(Color.WHITE);
        g2D.drawString("Lorem Ipsum", this.getWidth() / 2 - (int)(fontRect.getWidth() / 2), 200 + (int)(fontRect.getHeight() / 2));
