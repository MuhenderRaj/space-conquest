...
public class EnemyInfo extends JPanel{
    ...
    public void paintComponent(Graphics g){
        ...
        g2D.setFont(f);
        Rectangle2D fontRect = g.getFontMetrics().getStringBounds("Enemy Info", g2D);
        
        g2D.setColor(Color.WHITE);
        g2D.drawString("Enemy Info", this.getWidth() / 2 - (int)(fontRect.getWidth() / 2), 200 + (int)(fontRect.getHeight() / 2));
